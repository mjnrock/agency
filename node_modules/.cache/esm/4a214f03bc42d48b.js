let Context,Node,Registry,Observer;_bc4‍.w("./Context",[["default",["Context"],function(v){Context=v}]]);_bc4‍.w("./Node",[["default",["Node"],function(v){Node=v}]]);_bc4‍.w("./Registry",[["default",["Registry"],function(v){Registry=v}]]);_bc4‍.w("./Observer",[["default",["Observer"],function(v){Observer=v}]]);
...
ctx.attach(n2);
ctx.addListener("update", _bc4‍.g.console.log);
// ctx.addListener("hash", console.log);

const observer = new Observer(ctx);
observer.add(
    (...args) => _bc4‍.g.console.log(`OBSERVER`, ...args),
);
...
_bc4‍.g.console.log(reg);
_bc4‍.g.console.log(reg.get(false));
_bc4‍.g.console.log(reg.lookup(n1, true));
console.log("========");
