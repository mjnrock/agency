let validate,uuidv4,Context,Validator;_0dc‍.x([["default",()=>Registry]]);_0dc‍.w("uuid",[["validate",["validate"],function(v){validate=v}],["v4",["uuidv4"],function(v){uuidv4=v}]]);_0dc‍.w("./Context",[["default",["Context"],function(v){Context=v}]]);_0dc‍.w("./Validator",[["default",["Validator"],function(v){Validator=v}]]);
 ...
 */
    ...
    runValidator(idOrSynonym, ...args) {
        const validators = this.get(idOrSynonym);

        if(validators instanceof Validator) {
            return validators.run(...args);
        }
