let Context,Node,Registry;_9c3‍.w("./Context",[["default",["Context"],function(v){Context=v}]]);_9c3‍.w("./Node",[["default",["Node"],function(v){Node=v}]]);_9c3‍.w("./Registry",[["default",["Registry"],function(v){Registry=v}]]);
...
ctx.attach(n2);
ctx.addListener("update", _9c3‍.g.console.log);
...
_9c3‍.g.console.log(reg);
_9c3‍.g.console.log(reg.get(false));
_9c3‍.g.console.log(reg.lookup(n1, true));
console.log("========");

ctx.run([ true ], {
    reducerArgs: [ 5 ],
    exclude: (node, result, ...args) => false
}).then(([ state, txid ]) => _9c3‍.g.console.log(txid, state));
