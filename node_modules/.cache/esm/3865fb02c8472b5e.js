let validate,uuidv4,Context,Validator;_c84‍.x([["default",()=>Registry]]);_c84‍.w("uuid",[["validate",["validate"],function(v){validate=v}],["v4",["uuidv4"],function(v){uuidv4=v}]]);_c84‍.w("./Context",[["default",["Context"],function(v){Context=v}]]);_c84‍.w("./Validator",[["default",["Validator"],function(v){Validator=v}]]);
    ...
    valias(entry, ...synonyms) {
        if(typeof entry === "function") {
            const eid = this.add(new Validator(entry));
            this.addSynonym(eid, ...synonyms);
