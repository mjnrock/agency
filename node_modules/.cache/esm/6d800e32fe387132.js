let EventEmitter,uuidv4,hash,Validator;_fe3‍.x([["default",()=>Context]]);_fe3‍.w("events",[["default",["EventEmitter"],function(v){EventEmitter=v}]]);_fe3‍.w("uuid",[["v4",["uuidv4"],function(v){uuidv4=v}]]);_fe3‍.w("object-hash",[["default",["hash"],function(v){hash=v}]]);_fe3‍.w("./Validator",[["default",["Validator"],function(v){Validator=v}]]);




               class Context extends _fe3‍.a("EventEmitter",EventEmitter) {
    constructor(name, { state = {}, reducers = [], validators = [] } = {}) {
        super();

        this._id = _fe3‍.a("uuidv4",uuidv4)();
        this._name = name;
        this._state = state;
    ...
    __runOps(...args) {
        ...
        const txid = _fe3‍.a("uuidv4",uuidv4)();
        this.emit("update", this._state, txid);
        setTimeout(() => this.emit("hash", txid, _fe3‍.a("hash",hash)(this._state)));
    }
    attempt(validator, ...args) {
        if(validator instanceof _fe3‍.a("Validator",Validator) && validator.run(...args) === true) {
            this.__runOps(...args);
