let EventEmitter,uuidv4;_9cc‍.x([["default",()=>Node]]);_9cc‍.w("events",[["default",["EventEmitter"],function(v){EventEmitter=v}]]);_9cc‍.w("uuid",[["v4",["uuidv4"],function(v){uuidv4=v}]]);
    ...
    run(...args) {
        ...
        _9cc‍.g.console.log(this._mask, Node.LogicalType, this._mask & Node.LogicalType.CONJUNCT)
