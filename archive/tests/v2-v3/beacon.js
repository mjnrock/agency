...
beacon.attach(obs1);
// beacon.addPropListener("cat", (...args) => console.log(`BEACON:prop`, ...args));
// beacon.addObservableListener(ob1, (...args) => console.log(`BEACON:observable`, ...args));
beacon.addObserverListener(obs1, (...args) => console.log(`BEACON:observer`, ...args));
