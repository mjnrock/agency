...
var Emitter = exports.Emitter = function (_Watchable) {
    ...
    _createClass(Emitter, null, [{
        ...
        value: function GetEvent(namespace, event) {
            ...
            if (typeof namespace === "string" && namespace.length) {
                var cleanNamespace = namespace.replace(/^[.\s]+|[.\s]+$/g, "");
    ...
    function Emitter() {
        ...
        var _ref$state = _ref.state,
            ...
            rest = _objectWithoutProperties(_ref, ["state", "namespace"]);

        _classCallCheck(this, Emitter);

        var _this2 = _possibleConstructorReturn(this, (Emitter.__proto__ || Object.getPrototypeOf(Emitter)).call(this, state, _extends({}, rest)));
    ...
    _createClass(Emitter, [{
        ...
        get: function get() {
            ...
            return _extends({}, _get(Emitter.prototype.__proto__ || Object.getPrototypeOf(Emitter.prototype), "$", this), {
                ...
                addEvent: function addEvent(event, argsFn) {
