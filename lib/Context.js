...
var Context = function (_EventEmitter) {
    ...
    _createClass(Context, [{
        ...
        key: "attachTyped",
        value: function attachTyped(type, fn) {
            return this.attach(fn, new Agency.Proposition(Agency.Proposition.IsType(type), Agency.Proposition.IsMessageType(type)));
        }
