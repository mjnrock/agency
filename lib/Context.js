    ...
    _createClass(Context, [{
        ...
        value: function __add(dotKey, proposition) {
            if ((typeof dotKey === "undefined" ? "undefined" : _typeof(dotKey)) === "object") {
                ...
                try {
                    for (var _iterator = Object.entries(dotKey)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        value: function __include(name, variable) {
            if ((typeof name === "undefined" ? "undefined" : _typeof(name)) === "object") {
                ...
                try {
                    for (var _iterator2 = Object.entries(name)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
function Factory() {
    ...
    try {
        for (var _iterator4 = Object.entries(rules)[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
            var _step4$value = _slicedToArray(_step4.value, 2),
                dotKey = _step4$value[0],
                proposition = _step4$value[1];
    ...
    try {
        for (var _iterator5 = Object.entries(refs)[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
            var _step5$value = _slicedToArray(_step5.value, 2),
                name = _step5$value[0],
                variable = _step5$value[1];
