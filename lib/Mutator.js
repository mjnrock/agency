            ...
            if (Array.isArray(obj)) {
                ...
                if (this.__proposition) {
                    for (var i = 0; i < obj.length; i++) {
                        ...
                        var value = obj[i];
                        if ((_proposition3 = this.__proposition).test.apply(_proposition3, [i, value].concat(args)) === true) {
                            _res.push(value);
                        }
                    }
                }
            ...
            if (this.__proposition) {
                ...
                try {
                    for (var _iterator5 = Object.entries(obj)[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
                        ...
                        if ((_proposition4 = this.__proposition).test.apply(_proposition4, [key, _value].concat(args)) === true) {
                            res[key] = _value;
                        }
                    }
                } catch (err) {
        ...
        value: function apply() {
            ...
            if (Array.isArray(obj)) {
                ...
                for (var i = 0; i < obj.length; i++) {
                    ...
                    try {
                        for (var _iterator6 = this.__methods[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
                            var fn = _step6.value;

                            if (typeof fn === "function") {
                                res.push(fn.apply(undefined, [i, value].concat(args)));
                            } else if (fn instanceof Mutator) {
                                res.push(fn.mutate.apply(fn, [value, i, value].concat(args)));
                            }
                        }
                    } catch (err) {
            ...
            try {
                for (var _iterator7 = Object.entries(obj)[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
                    ...
                    try {
                        for (var _iterator8 = this.__methods[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
                            var _fn3 = _step8.value;

                            if (typeof _fn3 === "function") {
                                obj[key] = _fn3.apply(undefined, [key, obj[key]].concat(args));
                            } else if (_fn3 instanceof Mutator) {
                                obj[key] = _fn3.mutate.apply(_fn3, [obj[key], key, obj[key]].concat(args));
                            }
                        }
                    } catch (err) {
