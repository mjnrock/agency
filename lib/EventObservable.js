...
var EventObservable = exports.EventObservable = function (_Observable) {
    ...
    function EventObservable(eventEmitter) {
        ...
        var _ref = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {},
            ...
            windowDefault = _ref$windowDefault === undefined ? false : _ref$windowDefault;
            ...
            try {
                var _loop = function _loop() {
                    ...
                    _this2.__handlers[eventName] = function () {
                        ...
                        return (_updateFn = _this2.__updateFn).call.apply(_updateFn, [_this2, eventName].concat(args));
                    };
