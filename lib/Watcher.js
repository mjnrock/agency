...
var Watcher = exports.Watcher = function (_Emitter) {
    ...
    function Watcher() {
        ...
        var _ref$events = _ref.events,
            ...
            _ref$watchables = _ref.watchables,
            watchables = _ref$watchables === undefined ? [] : _ref$watchables,
            opts = _objectWithoutProperties(_ref, ["events", "watchables"]);

        _classCallCheck(this, Watcher);

        var _this2 = _possibleConstructorReturn(this, (Watcher.__proto__ || Object.getPrototypeOf(Watcher)).call(this, events, _extends({}, opts)));

        _this2.__handlers = new Set(handlers);

        if (watchables instanceof _Watchable2.default) {
                ...
                watch: function watch() {
                    ...
                    try {
                        for (var _iterator3 = watchables[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                            ...
                            if (watchable instanceof _Watchable2.default) {
...
function SubjectFactory(state) {
    ...
    return new Watcher(_Watchable2.default.Factory(state, opts));
};
