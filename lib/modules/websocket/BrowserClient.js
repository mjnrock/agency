...
var BrowserClient = exports.BrowserClient = function (_Client) {
    ...
    _createClass(BrowserClient, [{
        ...
        value: function QuickSetup() {
            ...
            return _get(BrowserClient.__proto__ || Object.getPrototypeOf(BrowserClient), "QuickSetup", this).call(this, opts, handlers, { state: state, packets: packets, clientClass: BrowserClient });
        }
    }]);
