...
var NodeClient = exports.NodeClient = function (_Client) {
    ...
    function NodeClient() {
        ...
        return _possibleConstructorReturn(this, (NodeClient.__proto__ || Object.getPrototypeOf(NodeClient)).call(this, state, alter, opts));
    }
    ...
    _createClass(NodeClient, [{
        ...
        value: function QuickSetup() {
            ...
            return _get(NodeClient.__proto__ || Object.getPrototypeOf(NodeClient), "QuickSetup", this).call(this, wsOpts, handlers, { state: state, packets: packets, clientClass: NodeClient, broadcastMessages: broadcastMessages });
        }
    }]);
