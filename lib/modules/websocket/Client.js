...
var Client = exports.Client = function (_Network) {
    ...
    function Client() {
        ...
        var _this = _possibleConstructorReturn(this, (Client.__proto__ || Object.getPrototypeOf(Client)).call(this, state, modify));
    ...
    _createClass(Client, [{
        ...
        value: function _bind(client) {
            ...
            client.addEventListener("close", function (code, reason) {
                return _this2.message(Client.Signal.CLOSE, code, reason);
            });
            client.addEventListener("error", function (error) {
                return _this2.message(Client.Signal.ERROR, error);
            });
            client.addEventListener("message", function (packet) {
                try {
                    ...
                    _this2.message(Client.Signal.MESSAGE, msg);
                } catch (e) {
                    _this2.message(Client.Signal.MESSAGE_ERROR, e, packet);
                }
            });
            client.addEventListener("open", function () {
                return _this2.message(Client.Signal.OPEN);
            });
            client.addEventListener("ping", function (data) {
                return _this2.message(Client.Signal.PING, data);
            });
            client.addEventListener("pong", function (data) {
                return _this2.message(Client.Signal.PONG, data);
            });
            client.addEventListener("unexpected-response", function (req, res) {
                return _this2.message(Client.Signal.UNEXPECTED_RESPONSE, req, res);
            });
            client.addEventListener("upgrade", function (res) {
                return _this2.message(Client.Signal.UPGRADE, res);
            });
        }
    }, {
        key: "useNodeBuffer",
            ...
            if (typeof timeout === "number" && timeout > 0) {
                setTimeout(function () {
                    try {
                        ...
                        _this3.message(Client.Signal.ERROR, e);
                    }
                }, timeout);
            }
        }
