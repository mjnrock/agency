...
var $Node = function $Node($super) {
    return function (_$super) {
        ...
        function _class() {
            ...
            _this.edges = new _Registry2.default({
        ...
        _createClass(_class, [{
            ...
            value: function request() {
                ...
                try {
                    for (var _iterator2 = this.edges[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                        ...
                        edge.request.apply(edge, [this].concat(args));
                    }
                } catch (err) {
            ...
            key: "respond",
            value: function respond(state) {
                return this;
            }
        }, {
            key: "response",
            value: function response(node) {
