...
var Network = exports.Network = function (_Watcher) {
    ...
    function Network() {
        ...
        var _ref$events = _ref.events,
            ...
            opts = _objectWithoutProperties(_ref, ["events", "parentKey"]);

        _classCallCheck(this, Network);

        var _this2 = _possibleConstructorReturn(this, (Network.__proto__ || Object.getPrototypeOf(Network)).call(this, [], _extends({ events: [].concat(_toConsumableArray(Network.Events), _toConsumableArray(events)) }, opts)));

        _this2.__parentKey = parentKey;

        _this2.emitters = new _Registry2.default();
        _this2.join.apply(_this2, _toConsumableArray(emitters));
        return _this2;
    }

    _createClass(Network, [{
        key: "join",
        value: function join(emitter) {
            if (emitter instanceof _Emitter2.default) {
                ...
                (_emitters = this.emitters).register.apply(_emitters, [emitter].concat(synonyms));
        ...
        value: function bulkJoin() {
            ...
            try {
                for (var _iterator = joinArgs[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    var _step$value = _toArray(_step.value),
                        emitter = _step$value[0],
                        _synonyms = _step$value.slice(1);

                    this.join.apply(this, [emitter].concat(_toConsumableArray(_synonyms)));
                }
            } catch (err) {
        ...
        value: function leave() {
            ...
            try {
                for (var _iterator2 = emitters[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                    ...
                    if (emitter instanceof _Emitter2.default) {
                        var bool = this.emitters.unregister(emitter).length;
        ...
        value: function attachEvent(event) {
            ...
            var emitters = typeof filter === "function" ? filter(this.emitters) : this.emitters;
            ...
            try {
                for (var _iterator4 = emitters[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
        ...
        key: "bulkAttachEvent",
        value: function bulkAttachEvent() {
            ...
            try {
                for (var _iterator5 = addEventArgs[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
        ...
        value: function detatchEvent() {
            ...
            try {
                for (var _iterator6 = this.emitters[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
        ...
        get: function get() {
            ...
            return _extends({}, _get(Network.prototype.__proto__ || Object.getPrototypeOf(Network.prototype), "$", this), {
