...
var _package = require("./components/package");
...
var Components = exports.Components = _package2.default;
...
function useObserver(context, prop) {
    ...
    (0, _react.useEffect)(function () {
        ...
        if (observable instanceof _Observable2.default) {
            ...
            obs = _Observer2.default.SubjectFactory(observable);
        }
        obs.on("next", fn);
