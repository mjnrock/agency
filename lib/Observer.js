    ...
    _createClass(Observer, [{
        ...
        set: function set(observable) {
            ...
            if (observable instanceof _Observable2.default || _util2.default.types.isProxy(observable)) {
                ...
                this.__subject.next = function (props, value, ob) {
                    _this2.emit(props, value, ob || observable, _this2);
                    _this2.emit("next", props, value, ob || observable, _this2);
                };
            } else if (observable instanceof Observer || observable instanceof _Beacon2.default) {
                this.__subject = observable;
