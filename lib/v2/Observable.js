...
function ToData(observable) {
    var excluded = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : ["__next"];
    ...
    try {
        for (var _iterator = Object.entries(observable)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
function Create(next) {
    ...
    if (arguments.length === 1 && (typeof next === "undefined" ? "undefined" : _typeof(next)) === "object" || next instanceof Observable) {
        state = ToData(next);
    }

    var obs = new Observable(next, {
        deep: isDeep
    });
