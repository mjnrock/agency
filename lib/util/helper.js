...
function arrayRange(input, length) {
    if (typeof input === "function") {
        return arrayRange(length).map(function (x, i) {
            return input(i);
        });
    }

    return Array.apply(null, Array(input)).map(function (x, i) {
        return i;
    });
}
