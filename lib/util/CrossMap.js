...
var CrossMap = exports.CrossMap = function () {
    ...
    _createClass(CrossMap, [{
        ...
        key: "get",
        value: function get() {
            for (var _len3 = arguments.length, coords = Array(_len3), _key3 = 0; _key3 < _len3; _key3++) {
                coords[_key3] = arguments[_key3];
            }
        ...
        value: function set(value) {
            for (var _len5 = arguments.length, coords = Array(_len5 > 1 ? _len5 - 1 : 0), _key5 = 1; _key5 < _len5; _key5++) {
                coords[_key5 - 1] = arguments[_key5];
            }
                ...
                for (var _iterator4 = dimensions[0][Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                    ...
                    if (dimensions.length > 1) {
                        ...
                        if (typeof seedFn === "function" && !saveFnInstead) {
                            root.set(value, seedFn.apply(undefined, [].concat(_toConsumableArray(chain), [value])));
                        } else {
        ...
        value: function toLeaf() {
            var _ref3 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
                _ref3$asObject = _ref3.asObject,
                asObject = _ref3$asObject === undefined ? false : _ref3$asObject,
                _ref3$flatten = _ref3.flatten,
                flatten = _ref3$flatten === undefined ? false : _ref3$flatten,
                rootMap = _ref3.rootMap;
            ...
            try {
                for (var _iterator6 = rootMap.entries()[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
                    ...
                    if (value instanceof Map) {
                        var results = this.toLeaf({ asObject: false, rootMap: value });

                        if (flatten) {
                            arr.push.apply(arr, _toConsumableArray(results));
                        } else {
                            arr.push(results);
                        }
                    } else {
        ...
        key: "cardinality",
        get: function get() {
            return this.size.reduce(function (a, v) {
                return a * v;
            }, 1);
        }
    }]);
