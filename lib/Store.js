            ...
            try {
                for (var _iterator3 = this.__reducers.values()[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                    ...
                    if (typeof result === "function") {
                        result = reducer.apply(undefined, [state !== void 0 ? state : this.__state].concat(args));
                    } else if (result instanceof _Mutator2.default) {
                        result = reducer.mutate.apply(reducer, [state !== void 0 ? state : this.__state].concat(args));
                    }
