...
var $Registry = function $Registry($super) {
    return function (_$super) {
        ...
        function _class() {
            ...
            Reflect.defineProperty(_this, "__cache", { // Used primarily for the reregistration of objects
                value: new WeakMap(),
                configurable: false,
                writable: true,
                enumerable: false
            });
            Reflect.defineProperty(_this, "__state", {
                value: {},
                configurable: false,
                writable: true,
                enumerable: false
            ...
            get: function get() {
                ...
                try {
                    for (var _iterator8 = this.synonyms[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
                        var synonym = _step8.value;

                        var _entry = this[synonym];
                        var current = map.get(_entry);

                        map.set(_entry, [].concat(_toConsumableArray(current), [synonym]));
                    }
                } catch (err) {
...
var Registry = exports.Registry = function (_compose) {
    ...
    function Registry() {
        ...
        try {
            ...
            for (var _iterator9 = registerArgs[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
