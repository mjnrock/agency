...
var Registry = exports.Registry = function (_Observable) {
                ...
                if ((0, _uuid.validate)(prop) || (0, _uuid.validate)(value)) {
                    if (deep && value instanceof _Observable3.default) {
                        ...
                        ob.next = function () {
                            ...
                            var props = target[prop] !== void 0 ? [].concat(_toConsumableArray(args.slice(0, args.length - 1))).join(".") : [prop].concat(_toConsumableArray(args.slice(0, args.length - 1))).join(".");
    ...
    _createClass(Registry, [{
        ...
        key: "entries",
        get: function get() {
            return Object.entries(this).reduce(function (a, _ref) {
        ...
        key: "values",
        get: function get() {
            return Object.entries(this).reduce(function (a, _ref3) {
        ...
        key: "synonyms",
        get: function get() {
            return Object.entries(this).reduce(function (a, _ref5) {
