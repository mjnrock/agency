    ...
    return function (_$super) {
        ...
        _createClass(_class, [{
            ...
            value: function unregister(lookup) {
                ...
                try {
                    for (var _iterator4 = Reflect.ownKeys(this)[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
            ...
            get: function get() {
                ...
                return Reflect.ownKeys(this).reduce(function (a, k) {
                    if ((k[0] !== "_" || k[0] === "_" && k[1] !== "_") && (0, _uuid.validate)(_this2[k])) {
            ...
            get: function get() {
                ...
                try {
                    for (var _iterator6 = Reflect.ownKeys(this)[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
...
var Registry = exports.Registry = function (_compose) {
    ...
    function Registry() {
        ...
        return _possibleConstructorReturn(this, (Registry.__proto__ || Object.getPrototypeOf(Registry)).call(this, opts));
    }
