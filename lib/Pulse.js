...
var Pulse = exports.Pulse = function (_Emitter) {
    ...
    function Pulse() {
        ...
        _this.loop = _mainloop2.default.setBegin(preUpdate.bind(_this)).setUpdate(_this.update.bind(_this)).setDraw(_this.draw.bind(_this)).setEnd(postUpdate.bind(_this)).setSimulationTimestep(_this.spb);
