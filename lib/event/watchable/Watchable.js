...
var WatchableArchetype = exports.WatchableArchetype = function (_compose) {
    _inherits(WatchableArchetype, _compose);
    ...
    function WatchableArchetype() {
        ...
        return _possibleConstructorReturn(this, (_ref = WatchableArchetype.__proto__ || Object.getPrototypeOf(WatchableArchetype)).call.apply(_ref, [this].concat(args)));
    }

    return WatchableArchetype;
}((0, _helper.compose)(_Emitter.$Emitter)(_AgencyBase2.default));

var wrapNested = exports.wrapNested = function wrapNested(controller, prop, input) {
    if (!(input instanceof _AgencyBase2.default)) {
        return input;
...
var Watchable = exports.Watchable = function (_WatchableArchetype) {
    ...
    function Watchable() {
        ...
        var _ref2 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
            ...
            _ref2$isStateSchema = _ref2.isStateSchema,
            isStateSchema = _ref2$isStateSchema === undefined ? false : _ref2$isStateSchema,
            _ref2$emitProtected = _ref2.emitProtected,
            emitProtected = _ref2$emitProtected === undefined ? false : _ref2$emitProtected,
            _ref2$emitPrivate = _ref2.emitPrivate,
            emitPrivate = _ref2$emitPrivate === undefined ? false : _ref2$emitPrivate,
            _ref2$useControlMessa = _ref2.useControlMessages,
            useControlMessages = _ref2$useControlMessa === undefined ? false : _ref2$useControlMessa;
    ...
    _createClass(Watchable, [{
        ...
        value: function toString() {
            var _ref4 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
                ...
                primary = _ref4$primary === undefined ? "|" : _ref4$primary,
                _ref4$secondary = _ref4.secondary,
                secondary = _ref4$secondary === undefined ? ":" : _ref4$secondary,
                all = _ref4.all;
            ...
            return (0, _helper.flatten)(this, { asArray: true }).map(function (_ref5) {
        ...
        value: function Unflatten(obj) {
            ...
            return new this((0, _helper.unflatten)(obj, unflattenOpts), opts);
        }
    }, {
        key: "Generate",
        ...
        value: function (_Factory) {
            ...
            for (var i = 0; i < qty; i++) {
                ...
                var watch = new (Function.prototype.bind.apply(this, [null].concat(_toConsumableArray(localArgs))))();
         ...
         */
        value: function (_AsyncFactory) {
            function AsyncFactory() {
                return _AsyncFactory.apply(this, arguments);
            }

            AsyncFactory.toString = function () {
                return _AsyncFactory.toString();
            };
