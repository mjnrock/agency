...
var Watchable = exports.Watchable = function (_WatchableArchetype) {
    ...
    function Watchable(network) {
        ...
        _this2.__controller = {
            controller: network.addConnection(_this2, { callback: function callback() {
                    return _this2.__receiveHook.apply(_this2, arguments);
                } }),
    ...
    _createClass(Watchable, [{
        ...
        key: "Unflatten",
        value: function Unflatten(network, obj) {
            var opts = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
            var unflattenOpts = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};

            return new Watchable(network, (0, _helper.unflatten)(obj, unflattenOpts), opts);
        }
    }]);
 ...
 */
function Factory(network) {
    var args = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
    var qty = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 1;
    var metaFactory = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
    ...
    for (var i = 0; i < qty; i++) {
        ...
        var watch = new (Function.prototype.bind.apply(Watchable, [null].concat([network], _toConsumableArray(localArgs))))();
 ...
 */
async function AsyncFactory(network) {
    var args = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
    var qty = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 1;
    var metaFactory = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
