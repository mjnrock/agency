            ...
            get: function get() {
                ...
                return _extends({}, _get(_class.prototype.__proto__ || Object.getPrototypeOf(_class.prototype), "$", this) || {}, {
                    emit: function emit(event) {
                        ...
                        try {
                            for (var _iterator3 = _this().__subscribers[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                    ...
                    asyncEmit: async function asyncEmit(event) {
                        ...
                        try {
                            for (var _iterator4 = _this().__subscribers[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
