...
function consoleProcessor(payload) {
    return [payload.type, _perf_hooks.performance.now()];
...
var Channel = exports.Channel = function (_Registry) {
    ...
    function Channel() {
        ...
        var _ref$globals = _ref.globals,
            ...
            config = _objectWithoutProperties(_ref, ["globals", "handlers"]);
    ...
    _createClass(Channel, [{
        key: "bus",
        value: function bus(payload, args) {
        ...
        value: function process() {
            ...
            while (!this.isEmpty && i < this.config.maxBatchSize) {
                var _dequeue = this.dequeue(),
                    _dequeue2 = _slicedToArray(_dequeue, 2),
                    payload = _dequeue2[0],
                    args = _dequeue2[1];

                var receivers = this.handlers["*"] || [];
                ...
                try {
                    for (var _iterator2 = receivers[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                        ...
                        if (typeof receiver === "function") {
                            receiver(payload, args, _extends({}, this.globals, { enqueue: this.enqueue.bind(this) }));
                        }
                    }
                } catch (err) {
                ...
                try {
                    for (var _iterator3 = handlers[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                        ...
                        if (typeof handler === "function") {
                            handler(payload, args, _extends({}, this.globals, { enqueue: this.enqueue.bind(this) }));
                        }
                    }
                } catch (err) {
