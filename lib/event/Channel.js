    ...
    _createClass(Channel, [{
                    ...
                    if (key === "$globals") {
                        ...
                        try {
                            for (var _iterator6 = Object.entries(value)[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
                                ...
                                this.removeHandler.apply(this, [k].concat(_toConsumableArray(v)));
                            }
                        } catch (err) {
        ...
        * 	as a de facto <Channel> filter.
        ...
        value: function invokeHandlers(message) {
            ...
            try {
                for (var _iterator7 = preHandlers[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
                    var pre = _step7.value;
            ...
            try {
                for (var _iterator9 = postHandlers[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
                    var post = _step9.value;
        ...
        value: function addHandlers() {
            ...
            try {
                for (var _iterator11 = addHandlerArgs.map(function (v) {
        ...
        value: function removeHandler(event) {
            ...
            if (this.handlers.get(event) instanceof Set) {
                ...
                try {
                    for (var _iterator12 = fns[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
        ...
        value: function removeHandlers() {
            ...
            try {
                for (var _iterator13 = addHandlerArgs.map(function (v) {
                    return Array.isArray(v) ? v : [v];
        ...
        value: function addReducers() {
            ...
            try {
                for (var _iterator14 = addReducerArgs.map(function (v) {
                    return Array.isArray(v) ? v : [v];
        ...
        value: function addEffect(event) {
            ...
            var newFn = function newFn(msg) {
                ...
                if (msg.type === event) {
                    ...
                    try {
                        for (var _iterator16 = fns[Symbol.iterator](), _step16; !(_iteratorNormalCompletion16 = (_step16 = _iterator16.next()).done); _iteratorNormalCompletion16 = true) {
        ...
        value: function addEffects() {
            ...
            try {
                for (var _iterator17 = addEffectArgs.map(function (v) {
                    return Array.isArray(v) ? v : [v];
                })[Symbol.iterator](), _step17; !(_iteratorNormalCompletion17 = (_step17 = _iterator17.next()).done); _iteratorNormalCompletion17 = true) {
                    var _step17$value = _toArray(_step17.value),
                        event = _step17$value[0],
                        _fns3 = _step17$value.slice(1);
