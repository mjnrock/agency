...
var Emitter = exports.Emitter = function (_AgencyBase) {
    ...
    _createClass(Emitter, [{
        key: "toggleSelfListening",
        value: function toggleSelfListening() {
            this.__config.useHandlerAsSelfListener = !this.__config.useHandlerAsSelfListener;
        ...
        key: "isSelfListening",
        get: function get() {
            return this.__config.useHandlerAsSelfListener;
        }
    }, {
        key: "subscribers",
        get: function get() {
            ...
            return {
                emit: async function emit(event) {
                    ...
                    if (payload.provenance.has(_this) === false) {
                        if (_this.__config.useHandlerAsSelfListener === true) {
                            var _this$$$_handle;

                            (_this$$$_handle = _this.$._handle).call.apply(_this$$$_handle, [payload].concat(args));
                        }
