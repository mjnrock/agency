...
var Emitter = exports.Emitter = function (_AgencyBase) {
    ...
    function Emitter() {
        ...
        if (injectMiddleware) {
            _EventBus2.default.Middleware(_this2);
        }
        return _this2;
    }
        ...
        get: function get() {
            ...
            return {
                ...
                _handle: function _handle() {
                    ...
                    if (payload.provenance.has(_this()) === false) {
                        ...
                        if (typeof _this().__filter === "function" && (_this$__filter = _this().__filter).call.apply(_this$__filter, [payload].concat(args)) === true) {
                            ...
                            try {
                                for (var _iterator9 = receivers[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
                                    var receiver = _step9.value;
                            ...
                            try {
                                for (var _iterator10 = handlers[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
                ...
                asyncEmit: async function asyncEmit(event) {
                    ...
                    try {
                        for (var _iterator11 = _this().__subscribers[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
                            var subscriber = _step11.value;
                ...
                _asyncHandler: async function _asyncHandler() {
                    ...
                    if (payload.provenance.has(_this()) === false) {
                        ...
                        if (typeof _this().__filter === "function" && (_this$__filter2 = _this().__filter).call.apply(_this$__filter2, [payload].concat(args)) === true) {
                            ...
                            try {
                                for (var _iterator12 = receivers[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
                                    var receiver = _step12.value;
