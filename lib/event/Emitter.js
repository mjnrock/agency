        ...
        get: function get() {
            ...
            return {
                emit: async function emit(event) {
                    ...
                    try {
                        for (var _iterator10 = _this.__subscribers[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
                ...
                _handle: async function _handle() {
                    ...
                    if (payload.provenance.has(_this) === false) {
                        ...
                        if (typeof _this.__filter === "function" && (_this$__filter2 = _this.__filter).call.apply(_this$__filter2, [payload].concat(args)) === true) {
                            ...
                            try {
                                for (var _iterator11 = receivers[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
                                    var receiver = _step11.value;
