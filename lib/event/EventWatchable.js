...
var EventWatchable = exports.EventWatchable = function (_Watchable) {
     ...
     */
    function EventWatchable(network, eventEmitter) {
        ...
        var _this = _possibleConstructorReturn(this, (EventWatchable.__proto__ || Object.getPrototypeOf(EventWatchable)).call(this, network, state, opts));
                ...
                var _loop = function _loop() {
                    ...
                    _this2.__handlers[eventName] = function () {
                        ...
                        if (_this2.__config.useAsRelayOnly) {
                            var _controller$controll;

                            var type = _this2.__config.namespace ? _this2.__config.namespace + "." + eventName : eventName;

                            (_controller$controll = _this2.__controller.controller).dispatch.apply(_controller$controll, [type].concat(args));
                        } else {
