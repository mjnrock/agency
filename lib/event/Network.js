...
var Network = exports.Network = function (_AgencyBase) {
    ...
    function Network() {
        ...
        _this.alter({
            ...
            default: {
                handlers: _defineProperty({}, Network.Signals.UPDATE, function (msg, _ref) {
    ...
    _createClass(Network, [{
        ...
        value: function broadcast(message) {
            ...
            try {
                for (var _iterator7 = this.__connections[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
