...
var Network = exports.Network = function (_AgencyBase) {
    ...
    function Network() {
        ...
        _this.alter({
            ...
            default: (_default = {}, _defineProperty(_default, Network.Signals.UPDATE, function (msg, _ref) {
    ...
    _createClass(Network, [{
        ...
        value: function join(entity) {
            ...
            if (!!entity && !callback) {
                return this.__emptyJoin(entity, { filter: filter, synonyms: synonyms, addSelfToDefaultGlobal: addSelfToDefaultGlobal });
            }

            (_connections = this.__connections).register.apply(_connections, [entity].concat(_toConsumableArray(synonyms)));

            var cache = this.__createCacheObject(entity, callback, filter, synonyms);
        ...
        value: function broadcast() {
            ...
            try {
                for (var _iterator5 = this.__connections[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
         ...
         */
        value: function getController(idOrSynonym) {
            var entity = this.__connections[idOrSynonym];
            var cache = this.__cache.get(entity) || {};
        ...
        value: function __createReceiverFn(entity) {
            ...
            return function () {
                ...
                var data = _this3.__cache.get(entity);
                ...
                if (wasUpdated) {
                    _this3.__cache.set(entity, data);
        ...
        value: function __createCacheObject(entity, callback, filter, synonyms) {
            var cache = {
