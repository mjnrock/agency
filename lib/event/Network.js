...
var Network = exports.Network = function (_AgencyBase) {
    ...
    function Network() {
        ...
        _this.__state = new _Watchable2.default(_this, state, {
    ...
    _createClass(Network, [{
                            ...
                            if (key === "$globals") {
                                ...
                                try {
                                    for (var _iterator6 = Object.entries(value)[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
                                        ...
                                        _channel.addMergeReducer(name, val);
                                    }
                                } catch (err) {
        ...
        */
        ...
        value: function broadcast() {
            ...
            try {
                for (var _iterator9 = this.__connections.values()[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
                    var _ref4 = _step9.value;
        ...
        value: function multiPass(msg) {
            ...
            if (exclude.length) {
                ...
                try {
                    for (var _iterator10 = this.ch[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
                ...
                try {
                    for (var _iterator11 = this.ch[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
                        var _channel2 = _step11.value;
        ...
        value: function __createCacheObject(entity, callback, filter) {
            var cache = {
                ...
                receiver: new _Receiver2.default(callback, function (msg) {
            ...
            cache.controller = {
                eid: (typeof entity === "undefined" ? "undefined" : _typeof(entity)) === "object" ? entity.id || entity._id || entity.__id || entity.uuid : entity,
