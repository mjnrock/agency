...
var Network = exports.Network = function (_AgencyBase) {
    ...
    _createClass(Network, [{
        ...
        key: "addConnection",
        value: function addConnection(entity) {
        ...
        value: function removeConnection(entity) {
            return this.__connections.delete(entity);
        }
    }, {
        key: "join",
        value: function join(network, opts) {
        ...
        value: function __emptyJoin(entity) {
            ...
            if (entity instanceof Network) {
                return this.addConnection(entity, _extends({}, opts, {
