...
var Channel = exports.Channel = function (_Registry) {
    _inherits(Channel, _Registry);

    function Channel(network) {
        ...
        var _ref$globals = _ref.globals,
            ...
            config = _objectWithoutProperties(_ref, ["globals", "handlers", "hooks", "state"]);
        ...
        _this._channelState = state;
        _this._channelStateDispatcher = new _Dispatcher2.default(network, _this);
        return _this;
    }
    ...
    _createClass(Channel, [{
        ...
        value: function invokeHandlers(payload) {
            ...
            var optionArgs = _extends({}, this.globals, {
                ...
                setState: function setState(state) {
                    return _this2.setState(state, false);
                },
                mergeState: function mergeState(state) {
                    return _this2.setState(state, true);
                },
        ...
        value: function setState() {
            ...
            if (isMerge) {
                newState = _extends({}, this._channelState, state);
            } else {
                newState = state;
            }

            var args = [Object.assign({}, newState), Object.assign({}, this._channelState), Object.assign({}, state)];
            setTimeout(function () {
                var _channelStateDispatch;

                return (_channelStateDispatch = _this3._channelStateDispatcher).dispatch.apply(_channelStateDispatch, [Channel.Signals.UPDATE].concat(args));
            }, 0);
