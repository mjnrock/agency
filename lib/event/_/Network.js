 ...
 */
var Network = function (_Registry) {
    ...
    function Network() {
        ...
        _this.router = new _Router2.default(_this, channels, routes);
        return _this;
    }
    ...
    _createClass(Network, [{
        ...
        value: function join(subject) {
            ...
            for (var _len7 = arguments.length, synonyms = Array(_len7 > 1 ? _len7 - 1 : 0), _key7 = 1; _key7 < _len7; _key7++) {
                synonyms[_key7 - 1] = arguments[_key7];
            }

            this.register.apply(this, [dispatcher].concat(synonyms));
            ...
            try {
                for (var _iterator6 = joinArgs[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
                    var _step6$value = _toArray(_step6.value),
                        subject = _step6$value[0],
                        _synonyms = _step6$value.slice(1);

                    dispatchers.set(subject, this.join.apply(this, [subject].concat(_toConsumableArray(_synonyms))));
                }
            } catch (err) {
        ...
        value: function channel() {
            var _channel = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "default";

            return this.router[_channel];
        }
    }, {
        key: "getState",
        value: function getState() {
            ...
            var ctx = this.channel(channel);

            if (ctx instanceof _Channel2.default) {
                return ctx.getState();
            }
        }
    }, {
        ...
        key: "storeGlobal",
        value: function storeGlobal(channelName, name, value) {
            if ((typeof name === "undefined" ? "undefined" : _typeof(name)) === "object") {
                this.router[channelName].globals = _extends({}, this.router[channelName].globals, name);
            } else {
        ...
        key: "unstoreGlobal",
        value: function unstoreGlobal(channelName, input) {
...
var BasicNetwork = exports.BasicNetwork = function (_Network) {
    ...
    function BasicNetwork() {
        ...
        var _ref2$channelName = _ref2.channelName,
            channelName = _ref2$channelName === undefined ? "default" : _ref2$channelName,
            _ref2$useBatch = _ref2.useBatch,
            useBatch = _ref2$useBatch === undefined ? false : _ref2$useBatch,
            rest = _objectWithoutProperties(_ref2, ["channelName", "useBatch"]);

        _classCallCheck(this, BasicNetwork);

        var _this2 = _possibleConstructorReturn(this, (BasicNetwork.__proto__ || Object.getPrototypeOf(BasicNetwork)).call(this));
        ...
        _this2.router.createChannel(channelName, _extends({ handlers: handlers }, rest));
        _this2.router.createRoute(function () {
            return channelName;
        });

        if (useBatch === true) {
            _this2.router.useBatchProcess();
        } else {
            _this2.router.useRealTimeProcess();
        }
        return _this2;
    }
    ...
    _createClass(BasicNetwork, [{
        ...
        value: function storeGlobal(name, key) {
            var _ref3 = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {},
                _ref3$channelName = _ref3.channelName,
                channelName = _ref3$channelName === undefined ? "default" : _ref3$channelName;

            return _get(BasicNetwork.prototype.__proto__ || Object.getPrototypeOf(BasicNetwork.prototype), "storeGlobal", this).call(this, channelName, name, key);
        }
    }, {
        key: "unstoreGlobal",
        value: function unstoreGlobal(name, key) {
            var _ref4 = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {},
                _ref4$channelName = _ref4.channelName,
                channelName = _ref4$channelName === undefined ? "default" : _ref4$channelName;

            return _get(BasicNetwork.prototype.__proto__ || Object.getPrototypeOf(BasicNetwork.prototype), "unstoreGlobal", this).call(this, channelName, name, key);
        }
    }]);
