...
var Router = exports.Router = function (_compose) {
    ...
    function Router(network) {
        ...
        _this2.createChannels(channels);
    ...
    _createClass(Router, [{
        ...
        value: function createChannel(name) {
            ...
            var channel = new (Function.prototype.bind.apply(_Channel2.default, [null].concat([this.network], args)))();
        ...
        value: function createChannels() {
            ...
            try {
                for (var _iterator7 = createChannelArgs[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
        ...
        value: function destroyChannels() {
            ...
            try {
                for (var _iterator8 = destroyChannelArgs[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
        ...
        value: function process() {
            ...
            try {
                for (var _iterator10 = channels[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
                    var nameOrChannel = _step10.value;

                    var _channel = this[nameOrChannel];
        ...
        value: function empty() {
            ...
            try {
                for (var _iterator12 = channels[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
                    ...
                    var _channel2 = this[name];

                    if (_channel2 instanceof _Channel2.default) {
                        _channel2.empty();
                    }
                }
            } catch (err) {
